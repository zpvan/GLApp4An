...
public class SpotLightRenderer implements GLSurfaceView.Renderer {
    ...
    private static final String U_LIGHT_CUTOFF = "u_Light.cutOff";
    private static final String U_LIGHT_OUTER_CUTOFF = "u_Light.outerCutOff";
    ...
    private int uLightCutOff;
    private int uLightOuterCutOff;
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        ...
        mObjectProgram = EsUtil.shaderCode2Program(
                ResUtil.readResource2String(mCtx, R.raw.spot_light_vertex_shader),
                ResUtil.readResource2String(mCtx, R.raw.spot_light_fragment_shader));
        ...
        uLightCutOff = GLES20.glGetUniformLocation(mObjectProgram, U_LIGHT_CUTOFF);
        uLightOuterCutOff = GLES20.glGetUniformLocation(mObjectProgram, U_LIGHT_OUTER_CUTOFF);
    ...
    public void onDrawFrame(GL10 gl) {
        ...
        GLES20.glUniform3f(uLightDirection, mEyeFront[0], mEyeFront[1], mEyeFront[2]);
        GLES20.glUniform3f(uLightPosition, mEyePosition[0], mEyePosition[1], mEyePosition[2]);
        GLES20.glUniform1f(uLightCutOff, (float) Math.cos(20.0f));
        GLES20.glUniform1f(uLightOuterCutOff, (float) Math.cos(30.0f));
