...
public class SpecularRenderer implements GLSurfaceView.Renderer {

    private static final String TAG = "SpecularRenderer";
    ...
    public SpecularRenderer(Context context) {
        mCtx = context;
    }
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        ...
        mObjectProgram = EsUtil.shaderCode2Program(
                ResUtil.readResource2String(mCtx, R.raw.specular_vertex_shader),
                ResUtil.readResource2String(mCtx, R.raw.specular_fragment_shader));
