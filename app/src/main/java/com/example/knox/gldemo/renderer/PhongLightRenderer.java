...
public class PhongLightRenderer implements GLSurfaceView.Renderer {

    private static final String TAG = "PhongLightRenderer";
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        ...
        mObjectProgram = EsUtil.shaderCode2Program(
                ...
                ResUtil.readResource2String(mCtx, R.raw.phonglight_fragment_shader));
