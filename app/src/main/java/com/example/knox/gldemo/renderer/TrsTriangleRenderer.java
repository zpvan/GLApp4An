...
public class TrsTriangleRenderer implements GLSurfaceView.Renderer {
    ...
    private final        float   mTranslateX              = -1f;
    private final        float   mTranslateY              = 0.3f;
    ...
    public TrsTriangleRenderer(Context context) {
        mCtx = context;
    }
