...
/**
 * @author Knox.Tsang
 * @time 2019/1/22  11:07
 * @desc ${TODD}
 */

public class PointLightRenderer implements GLSurfaceView.Renderer {

    private static final String TAG = "PointLightRenderer";
    ...
    private static final String U_LIGHT_POSITION = "u_Light.position";
    private static final String U_LIGHT_CONSTANT = "u_Light.constant";
    private static final String U_LIGHT_LINEAR = "u_Light.linear";
    private static final String U_LIGHT_QUADRATIC = "u_Light.quadratic";
    ...
    private int uLightConstant;
    private int uLightLinear;
    private int uLightQuadratic;
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        ...
        mObjectProgram = EsUtil.shaderCode2Program(
                ResUtil.readResource2String(mCtx, R.raw.point_light_vertex_shader),
                ResUtil.readResource2String(mCtx, R.raw.point_light_fragment_shader));
        ...
        uLightPosition = GLES20.glGetUniformLocation(mObjectProgram, U_LIGHT_POSITION);
        uLightConstant = GLES20.glGetUniformLocation(mObjectProgram, U_LIGHT_CONSTANT);
        uLightLinear = GLES20.glGetUniformLocation(mObjectProgram, U_LIGHT_LINEAR);
        uLightQuadratic = GLES20.glGetUniformLocation(mObjectProgram, U_LIGHT_QUADRATIC);
    ...
    public void onDrawFrame(GL10 gl) {
        ...
        GLES20.glUniform3f(uLightPosition, mLightPosition[0], mLightPosition[1], mLightPosition[2]);
        GLES20.glUniform1f(uLightConstant, 1.0f);
        GLES20.glUniform1f(uLightLinear, 0.09f);
        GLES20.glUniform1f(uLightQuadratic, 0.032f);
